...
struct TestLoopNetworkSharedStateInner {
    ...
    /// Per-shard snapshot host tracking. Keyed by AccountId for deterministic ordering.
    snapshot_hosts: HashMap<ShardId, BTreeSet<AccountId>>,
