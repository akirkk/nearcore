...
class DynamicResharding(TestSetup):
    ...
    def __init__(self, args):
        ...
        self.regions = "europe-west4,asia-east1,us-west1,us-east1"
        self.neard_binary_url = "https://s3-us-west-1.amazonaws.com/build.nearprotocol.com/nearcore/Linux-x86_64/wiezzel/dynamic-resharding-test-v3/a6cec30b0c4449724c5b17b281129a0891ee52d3/release/neard"
