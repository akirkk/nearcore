...
class DynamicResharding(TestSetup):
    ...
    def __init__(self, args):
        ...
        self.neard_binary_url = "https://s3-us-west-1.amazonaws.com/build.nearprotocol.com/nearcore/Linux-x86_64/master/897be93c075f47fd1f27336c287803f81db18f42/release/neard"
